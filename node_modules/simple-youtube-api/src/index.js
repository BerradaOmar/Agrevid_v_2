...
class YouTube {
     ...
     *  .catch(console.error);
     */
    search(query, limit = 5, options = {},pageToken) {
        console.log('pageToken from index !'+pageToken);
        return this.request.getPaginated(Constants.ENDPOINTS.Search, limit, Object.assign(options, { q: query, part: Constants.PARTS.Search }),pageToken)
     ...
     *  .catch(console.error);
     */
    searchVideos(query, limit = 5, options = {},pageToken) {
        return this.search(query, limit, Object.assign(options, { type: 'video' }),pageToken);
    }
